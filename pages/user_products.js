...
export default function UserProducts() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>המוצרים שלי - VidGenAI</title>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center space-x-3 space-x-reverse">
                          <button
                            ...
                            title="צור תוכן לקמפיין למוצר"
                          >
                            <span>🎬</span>
                            <span className="hidden sm:inline">צור תוכן לקמפיין למוצר</span>
                          </button>
                          <button
                            onClick={() => handleEdit(product)}
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <Link href="/" className="text-xl font-bold mb-4 hover:text-blue-400 transition-colors block">
                VidGenAI
              </Link>
